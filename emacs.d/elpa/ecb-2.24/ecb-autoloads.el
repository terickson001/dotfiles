...
;;;***

;;;### (autoloads nil "ecb-buffertab" "ecb-buffertab.el" (0 0 0 0))
;;; Generated autoloads from ecb-buffertab.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ecb-buffertab" '("ecb-buffertab-map")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ecb-compatibility" '("ecb-compatibility-advices")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ecb-eshell" '("ecb-eshell-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ecb-examples" '("ecb-examples-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ecb-file-browser" '("ecb-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ecb-layout" '("ecb-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ecb-method-browser" '("ecb-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ecb-multiframe" '("ecb-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ecb-speedbar" '("ecb-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ecb-util" '("ecb-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ecb-winman-support" '("ecb-winman-")))
...
;;;***

;;;### (autoloads nil nil ("ecb-cycle.el" "ecb-pkg.el") (0 0 0 0))
